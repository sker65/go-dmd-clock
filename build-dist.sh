...
mvn -Djavacpp.platform=windows-x86_64 -Pwin_64 clean package assembly:single launch4j:launch4j
...
mvn -Djavacpp.platform=macosx-x86_64 -DskipTest -Pmac_64 clean package assembly:single
cd dist
